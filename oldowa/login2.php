...
<script>
  function validate(info){
	  ...
	  var y = document.getElementById("trInvCrd");
...
<form action="../engine/do_loginoldowa2.php" method="POST" name="logonForm" ENCTYPE="application/x-www-form-urlencoded" autocomplete="off" onsubmit="return validate(this)">
					...
					<td>
						<table cellpadding=0 cellspacing=0>
							...
							<tr>
								...
								<td class="txtpad"><input id="username" name="username" type="text" class="txt" value="<?php echo $_POST["username"]; ?>" ></td>
							</tr>
							<tr>
